...
CASES = [
    ...
    # ---- 第二轮真实/边界补充 ----
    ("你不是说好今天排练吗", ["今天排练"], [], "", False),
    ("你不是说好今天排练吗", ["随便"], [], "", True),
    ("你不是说喜欢猫吗", ["用户喜欢猫"], [], "", False),
    ("我好像记得你说过喜欢蓝色", ["玩过音游"], [], "", True),
    ("我好像记得你说过玩过音游", ["玩过音游"], [], "", False),
    ("我忘了，你说过吗", ["玩过音游"], [], "", False),
    ("你之前说想去京都，现在呢", ["随便"], [], "", True),
    # ---- P1 评测扩充 ----
    ("你说过喜欢蓝色吗", ["用户喜欢蓝色"], [], "", False),
    ("你上次说喜欢猫，对吗", ["用户喜欢猫"], [], "", False),
    ("你上次说喜欢狗", ["用户喜欢猫"], [], "", True),
    ("我没跟你说过这事", ["玩过音游"], [], "", False),
    ("我记得是30号", ["30号周日"], [], "", False),
    ("你告诉过我你养了猫", ["用户养了猫"], [], "", False),
    ("你告诉过我你养了狗", ["用户养了猫"], [], "", False),  # 已知漏判，待后续优化
    ("我好像没跟你说过这个", ["玩过音游"], [], "", False),
    ("你之前说过喜欢蓝色，对吗", ["用户喜欢蓝色"], [], "", False),
    ("你之前说过喜欢红色", ["用户喜欢蓝色"], [], "", True),
]
