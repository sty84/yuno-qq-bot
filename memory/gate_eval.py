...
CASES = [
    ...
    # ---- 从真实 reply_eval_history 补充 ----
    ("橘色。你上周不是还跟我提过一嘴嘛。怎么，想让我夸夸你眼光好？", ["我养了只橘猫叫煤球"], [], "", True),
    ("橘色啊。你上周才亲口跟我说的。怎么，这么快就忘了？", ["我养了只橘猫叫煤球"], [], "", True),
    ("橘色嘛。你上周跟我说的，我记得挺清楚，橘色挺适合你的。", ["我养了只橘猫叫煤球"], [], "", True),
    ("奶茶？我好像没跟你约过这个。你自己想喝吧。", [], [], "", False),
    ("我好像没跟你约过这个。你记错人了吧。", [], [], "", False),
    ("阿拉蕾是雪貂？谁跟你说的……我印象里没这回事。", [], ["雪貂"], "", False),
    ("阿拉蕾是雪貂？ 你从哪听来的……我们自己团里那人就叫仲町阿拉蕾，是人。", [], ["雪貂"], "", False),
]
